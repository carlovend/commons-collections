...
public class CollectionUtils {
    ...
    public static final String COLL_1 = "coll1";
    public static final String COLL_2 = "coll2";
    public static final String EQUATOR = "equator";
    public static final String COLLECTION = "collection";
    public static final String UNSUPPORTED_OBJECT_TYPE = "Unsupported object type: ";
    ...
    public static boolean containsAll(final Collection<?> coll1, final Collection<?> coll2) {
        Objects.requireNonNull(coll1, COLL_1);
        Objects.requireNonNull(coll2, COLL_2);
        if (coll2.isEmpty()) {
            return true;
        }
    ...
    public static Object get(final Object object, final int index) {
        ...
        try {
            ...
            throw new IllegalArgumentException(UNSUPPORTED_OBJECT_TYPE + object.getClass().getName());
        }
    }
