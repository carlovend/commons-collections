...
public class Flat3Map<K, V> implements IterableMap<K, V>, Serializable, Cloneable {
    private static final String INVALIDMAP = "Invalid map index: ";
    private static final String THISMAP = "(this Map)";
    ...
    private void convertToMap() {
        ...
        case 0:
            break;
        default:
            throw new IllegalStateException(INVALIDMAP + size);
        }
    ...
    static class FlatMapIterator<K, V> implements MapIterator<K, V>, ResettableIterator<K> {
        ...
        public K getKey() {
            ...
            throw new IllegalStateException(INVALIDMAP + nextIndex);
        }
    ...
    static class FlatMapEntry<K, V> implements Map.Entry<K, V> {
        ...
        public K getKey() {
            ...
            throw new IllegalStateException(INVALIDMAP + index);
        }
    ...
    public String toString() {
        ...
        switch (size) {  // drop through
        case 3:
            buf.append(key3 == this ? THISMAP : key3);
            buf.append('=');
            buf.append(value3 == this ? THISMAP : value3);
            buf.append(CollectionUtils.COMMA);
        case 2:
            buf.append(key2 == this ? THISMAP : key2);
            buf.append('=');
            buf.append(value2 == this ? THISMAP : value2);
            buf.append(CollectionUtils.COMMA);
        case 1:
            buf.append(key1 == this ? THISMAP : key1);
            buf.append('=');
            buf.append(value1 == this ? THISMAP : value1);
            break;
